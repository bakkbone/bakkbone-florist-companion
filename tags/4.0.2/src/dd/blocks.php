...
class BKF_Delivery_Date_Block{
	...
	function __construct(){
		...
		add_action("init", [$this, 'bkfScheduleDdPurge']);
		add_action("bkf_dd_purge", [$this, 'bkfDdPurge']);
		add_action("admin_menu", [$this,"bkf_admin_menu"], 5);
		add_action("admin_init", [$this,"bkfAddDdBlocksInit"]);
	}
	...
	function bkf_admin_menu(){
		...
		"manage_woocommerce",
		"bkf_ddb",
		[$this, 'bkf_dd_blocks_page'],
		5
		);
		add_action( 'load-'.$admin_page, [$this, 'bkf_ddb_help_tab'] );
	}
	
	function bkf_ddb_help_tab(){
		$screen = get_current_screen();
		$id = 'bkf_ddb_help';
		$callback = [$this, 'bkf_ddb_help'];
	...
	function bkf_ddb_help(){
		...
		<h2><?php esc_html_e('View documentation for this page at: ','bakkbone-florist-companion'); ?></h2>
			<a href="https://docs.floristpress.org/dd/blocked-dates/" target="_blank">https://docs.floristpress.org/dd/blocked-dates/</a>
		<?php
	}
	...
	function bkf_dd_blocks_page(){
		...
		<div class="wrap">
			<div class="bkf-box">
			<h1><?php esc_html_e("Delivery Date Blocks","bakkbone-florist-companion") ?></h1>
			<p style="margin-top:0;"><?php esc_html_e("Click a block on the calendar to delete it.", "bakkbone-florist-companion"); ?></p>
