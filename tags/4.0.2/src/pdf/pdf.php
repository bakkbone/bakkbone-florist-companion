...
class BKF_PDF_Core{
	...
	function worksheet($orderid){
		...
		$cardmessage = $order->get_meta('_card_message') !== '' ? '<div class="bottom-sticky"><h3 class="nomargin">'.esc_html__('Card Message', 'bakkbone-florist-companion').'</h3><p class="nomargin monospace" style="font-size:18px;">'.nl2br($order->get_meta('_card_message')).'</p></div>' : '';
