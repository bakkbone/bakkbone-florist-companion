	...
	<script id="bkf_dd_filter">
	    	    jQuery(document).ready(function( $ ) {
				        ...
				        afterShow.done(function(){
				            ...
				            var btn = jQuery('<button class="ui-datepicker-current ui-state-default ui-priority-primary ui-corner-all" type="button"><?php _e('Clear', 'bakkbone-florist-companion'); ?></button>');
