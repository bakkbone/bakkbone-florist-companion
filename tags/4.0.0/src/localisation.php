...
class BKF_Localisation{
	...
	function __construct() {
		...
		add_action("admin_menu", [$this, "bkf_localisation_menu"], 60);
		add_action("admin_init", [$this, "bkfAddLocalisationPageInit"]);
	...
	function bkf_localisation_menu(){
		...
		$admin_page = add_submenu_page(
			...
			"manage_woocommerce",
			"bkf_localisation",
			[$this, 'bkf_localisation_settings_page'],
			60
		);
		add_action( 'load-'.$admin_page, [$this, 'bkf_localisation_help_tab'] );
	}
	
	function bkf_localisation_help_tab(){
		$screen = get_current_screen();
		$id = 'bkf_localisation_help';
		$callback = [$this, 'bkf_localisation_help'];
	...
	function bkf_localisation_help(){
		...
		<h2><?php esc_html_e('View documentation for this page at: ','bakkbone-florist-companion'); ?></h2>
			<a href="https://docs.floristpress.org/florist-options/localisation/" target="_blank">https://docs.floristpress.org/florist-options/localisation/</a>
		<?php
	}
	...
	function bkfAddLocalisationPageInit(){
		...
		register_setting(
			...
			[$this, "bkfAddLocalisationOptionsSanitize"]
		);
