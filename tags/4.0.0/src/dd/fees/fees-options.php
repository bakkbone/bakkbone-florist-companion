...
class BKF_Delivery_Date_Fees_Options{
	...
	function __construct(){
		...
		add_action("admin_menu", [$this, "bkfee_admin_menu"], 8.11);
		add_action("admin_init", [$this, "bkfAddFeesPageInit"]);
	}
	...
	function bkfee_admin_menu(){
		...
		"manage_woocommerce",
		"bkf_fees",
		[$this, 'bkf_fees_settings_page'],
		8.11
		);
		add_action( 'load-'.$admin_page, [$this, 'bkf_fee_help_tab'] );
	}
	
	function bkf_fee_help_tab(){
		$screen = get_current_screen();
		$id = 'bkf_fee_help';
		$callback = [$this, 'bkf_fee_help'];
	...
	function bkf_fee_help(){
		...
		<h2><?php esc_html_e('View documentation for this page at: ','bakkbone-florist-companion'); ?></h2>
			<a href="https://docs.floristpress.org/dd/fees/" target="_blank">https://docs.floristpress.org/dd/fees/</a>
		<?php
	}
	...
	function bkfAddFeesPageInit(){
		...
		register_setting(
			...
			"bkf_ddf_setting",
			[$this, 'bkfAddDdfOptionsSanitize']
		);
		register_setting(
			"bkf_ddf_options_group",
			"bkf_wf_setting",
			[$this, 'bkfAddWfOptionsSanitize']
		);
