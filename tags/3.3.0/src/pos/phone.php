	...
	function admin_notice(){
		...
		if($pagenow == 'admin.php' && isset($_GET['page']) && $_GET['page'] == 'new-phone_order'){
			...
			<div class="notice notice-bkf">
				<p><?php esc_html_e( 'This form does not yet support fees configured in FloristPress settings (other than timeslot fees), this is planned for the next major release. Apologies for any inconvenience caused.', 'bakkbone-florist-companion' ); ?></p>
			</div>
			<?php
		}
	}
