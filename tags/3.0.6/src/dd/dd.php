...
class BkfDd{
	...
	function __construct(){
		add_action('woocommerce_before_checkout_shipping_form', array($this,'bkf_dd_field_init'), 10 );
		...
		add_action('woocommerce_before_checkout_shipping_form', array($this, 'bkf_delivery_details'), 20);
	}
