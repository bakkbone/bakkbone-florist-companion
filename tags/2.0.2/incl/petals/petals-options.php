...
class BkfPetalsOptions{
	...
	function __construct()
	{
	    if(get_option('bkf_features_setting')['petals_on'] == true){
    		if(is_admin()){
    			...
    			add_action("admin_menu",array($this,"bkfAddPetalsPageOption"));
	...
	function bkfAddPetalsPageOption()
	{
		add_submenu_page(
			...
			__("Petals Network Integration","bakkbone-florist-companion"), //$page_title
			__("Petals Network","bakkbone-florist-companion"), //$menu_title
			"manage_options", //$capability
			"bkf_petals",//$menu_slug
			array($this,"bkfPetalsOptionsPageContent"),//$content
			50
		);
	}
	...
	{
		register_setting(
			"bkf_petals_options_group",// group
			"bkf_petals_setting", //setting name
			array($this,"bkfAddPetalsOptionsSanitize") //sanitize_callback
		);
		register_setting(
			"bkf_petals_options_group",// group
			"bkf_petals_product_setting", //setting name
			array($this,"bkfAddPetalsProductOptionsSanitize") //sanitize_callback
		);
