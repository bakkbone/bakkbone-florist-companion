...
<?php ?>
<p><?php printf( __( 'The outcome of your Petals action is listed below.', 'bakkbone-florist-companion' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
