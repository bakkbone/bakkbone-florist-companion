...
class BKF_Petals_Email{
	...
	public function __construct() {
		...
		if($bkfoptions["petals_on"]) {
			add_action('woocommerce_email_classes', [$this, 'bkf_register_petals_email'], 90, 1 );
			define('__BKF_WC_PETALS_EMAIL_PATH__', plugin_dir_path( __FILE__ ) );
			add_action('woocommerce_email_order_meta', [$this, 'bkf_add_order_notes_to_email'], 10, 3 );
			add_action('woocommerce_order_status_changed', [$this, 'bkf_woocommerce_petals_status_changed'], PHP_INT_MAX, 4 );
		}
	}
