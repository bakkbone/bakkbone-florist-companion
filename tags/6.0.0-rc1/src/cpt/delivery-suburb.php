...
class BKF_CPT_Delivery_Suburb{
	...
	function __construct(){
		...
		add_action("load-edit.php", [$this, 'dspost_help_tab']);
		add_action("load-post.php", [$this, 'dspost_help_tab']);
		add_action("load-post-new.php", [$this, 'dspost_help_tab']);
		add_action("admin_init", [$this, 'settingsfield']);
	}
	...
	function dspost_help(){
		...
		<h2><?php esc_html_e('View documentation for this page at: ','bakkbone-florist-companion'); ?></h2>
			<a href="https://docs.floristpress.org/suburbs-post/using-delivery-suburbs-posts/" target="_blank">https://docs.floristpress.org/suburbs-post/using-delivery-suburbs-posts/</a>
		<?php
	}
