<?php
/**
 * Class WC_Email_Draft_Phone_Order file
 *
...
if ( ! class_exists( 'WC_Email_Draft_Phone_Order' ) ) :

	/**
	 * Draft Phone Order Email.
	 *
	 * An email sent to the admin when a new Draft Phone Order is created.
	 *
	 * @class	   WC_Email_Draft_Phone_Order
	 * @version	 2.0.0
	 * @package	 WooCommerce\Classes\Emails
	 * @extends	 WC_Email
	 */
	class WC_Email_Draft_Phone_Order extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id			 = 'draft_phone_order';
			$this->customer_email = false;
			$this->title		  = __( 'Draft Phone Order', 'bakkbone-florist-companion' );
			$this->description	= __( 'Draft Phone Order emails are sent when a phone order is created and its status is set to Draft.', 'bakkbone-florist-companion' );
			$this->template_html  = 'emails/draft-phone-order.php';
			$this->template_plain = 'emails/plain/draft-phone-order.php';
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Draft Phone Order #{order_number}', 'bakkbone-florist-companion' );
		}
		...
		public function get_default_heading() {
			return __( 'Draft Phone Order: #{order_number}', 'bakkbone-florist-companion' );
		}
		...
		public function get_default_additional_content() {
			return __( 'You can manage this order from your website\'s dashboard.', 'bakkbone-florist-companion' );
		}
