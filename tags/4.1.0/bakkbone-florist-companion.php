...
require __BKF_PATH__ . "/src/functions.php";
require __BKF_PATH__ . "/lib/dompdf/autoload.inc.php";
require __BKF_PATH__ . "/lib/phonenumber/autoload.inc.php";
require __BKF_PATH__ . "/src/cpt/delivery-suburb.php";
require __BKF_PATH__ . "/src/enqueue.php";
require __BKF_PATH__ . "/src/options.php";
require __BKF_PATH__ . "/src/shortcodes.php";
require __BKF_PATH__ . "/src/admin-notices.php";
require __BKF_PATH__ . "/src/core.php";
require __BKF_PATH__ . "/src/pickup.php";
require __BKF_PATH__ . "/src/pdf/pdf.php";
require __BKF_PATH__ . "/src/pdf/pdf-options.php";
require __BKF_PATH__ . "/src/pdf/actions.php";
require __BKF_PATH__ . "/src/dd/dd.php";
require __BKF_PATH__ . "/src/dd/filter.php";
require __BKF_PATH__ . "/src/dd/sameday.php";
require __BKF_PATH__ . "/src/dd/fees/fees.php";
require __BKF_PATH__ . "/src/dd/fees/date-specific.php";
require __BKF_PATH__ . "/src/dd/fees/fees-options.php";
require __BKF_PATH__ . "/src/dd/dd-options.php";
require __BKF_PATH__ . "/src/dd/blocks.php";
require __BKF_PATH__ . "/src/dd/catblocks.php";
require __BKF_PATH__ . "/src/dd/calendar.php";
require __BKF_PATH__ . "/src/dd/timeslots.php";
require __BKF_PATH__ . "/src/localisation.php";
require __BKF_PATH__ . "/src/order-status.php";
require __BKF_PATH__ . "/src/petals/petals-options.php";
require __BKF_PATH__ . "/src/petals/petals.php";
require __BKF_PATH__ . "/src/petals/email.php";
require __BKF_PATH__ . "/src/petals/outbound.php";
require __BKF_PATH__ . "/src/petals/messaging.php";
require __BKF_PATH__ . "/src/petals/cpt.php";
require __BKF_PATH__ . "/src/emails/status-email.php";
require __BKF_PATH__ . "/src/emails/override.php";
require __BKF_PATH__ . "/src/suburbs/method.php";
require __BKF_PATH__ . "/src/notifier.php";
require __BKF_PATH__ . "/src/svg.php";
require __BKF_PATH__ . "/src/pos/phone.php";
require __BKF_PATH__ . "/src/ajax.php";
require __BKF_PATH__ . "/src/tools.php";
