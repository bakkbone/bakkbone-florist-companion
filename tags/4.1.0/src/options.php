...
class BKF_Options{
	...
	function bkfAPCallback(){
		...
		?>
		<label class="bkf-check-container"><?php esc_html_e("Automatically change all orders to Processed", "bakkbone-florist-companion") ?><input id="bkf-confirm-email" <?php echo $checked ?> type="checkbox" class="bkf-form-control"  name="bkf_features_setting[autoprocess]" /><span class="bkf-check-checkmark"></span></label>
		<?php
	}
