...
if ( ! class_exists( 'WC_Email_Petals_Note' ) ) :
	 ...
	 * Petals Note Email.
	 *
	 * An email sent to the admin when a new Petals Note is received.
	 *
	...
	class WC_Email_Petals_Note extends WC_Email {
		...
		public function __construct() {
			$this->id             = 'petals_note';
			$this->title          = __( 'Petals Note', 'woocommerce' );
			$this->description    = __( 'Petals Note emails are sent to chosen recipient(s) when a note from Petals is received.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Order #{order_number} - Petals Note', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Petals Note for order: #{order_number}', 'woocommerce' );
		}
