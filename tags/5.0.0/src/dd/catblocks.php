 ...
 * @package BKF_Delivery_Date_Category_Block
 * @license GNU General Public License (GPL) 3.0
**/

defined("__BKF_EXEC__") or die("Ah, sweet silence.");

class BKF_Delivery_Date_Category_Block{

	function __construct(){
		global $bkf_dd_cb_db_version;
		$bkf_dd_cb_db_version = '1.0';
		register_activation_hook( __BKF_FILE__, [$this, 'bkf_dd_cbs_db_init']);
		add_action("init", [$this, 'bkfScheduleCbPurge']);
		add_action("bkf_cb_purge", [$this, 'bkfCbPurge']);
		add_action("admin_menu", [$this, "bkf_admin_menu"], 6);
		add_action("admin_init", [$this, "bkfAddDdCbInit"]);
	...
	function bkf_admin_menu(){
		...
		add_action( 'load-'.$admin_page, [$this, 'bkf_cb_help_tab'] );
	}
	
	function bkf_cb_help_tab(){
		$screen = get_current_screen();
		$id = 'bkf_cb_help';
		$callback = [$this, 'bkf_cb_help'];
	...
	function bkf_cb_help(){
		...
		<h2><?php esc_html_e('View documentation for this page at: ','bakkbone-florist-companion'); ?></h2>
			<a href="https://docs.floristpress.org/dd/categories/" target="_blank">https://docs.floristpress.org/dd/categories/</a>
		<?php
	}
