...
class BKF_Ajax{
	...
	function __construct(){
		...
		// Shipping class non-floral settings
		add_action('wp_ajax_bkf_nonfloral', [$this, 'nonfloral']);
		
		// Non-floral exclude shipping
		add_action('wp_ajax_bkf_nonfloral_exclude_shipping', [$this, 'nonfloral_exclude_shipping']);
