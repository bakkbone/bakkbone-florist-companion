...
class BKF_Admin_Notices{
	...
	function check_plugin_compatibility(){
		...
		foreach($incompatible as $offender){
			...
			echo '<div class="notice-error notice"><p>'. sprintf(__('<strong>%1s</strong> requires at least version <strong>%2s</strong> of %3s – please update %3s.','bakkbone-florist-companion'), $offender['Title'], $requires, $bkftitle, $bkftitle).'</p></div>';
		}
	}
