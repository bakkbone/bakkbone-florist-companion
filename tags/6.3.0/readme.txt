...
== Changelog ==
### 6.3.0
* ADD: Customization of delivery date field label
...
### 5.1.0
* ADD: Delivery Suburb Search element for Breakdance
* TWEAK: Minify CSS and JS
* DEV: Fix dd purge removing incorrect items
### 5.0.6
* DEV: Dompdf v2.0.4 compatibility – make DejaVu Sans default font
### 5.0.5.1
* DEV: Fix ACF path
### 5.0.5
* TWEAK: Fix slashes in suburb search shortcode's results
### 5.0.4
* DEV: Tweak order statuses shown in dash widgets
...
### 5.0.1
* TWEAK: Prevent adding empty delivery date blocks
### 5.0.0
...
== Upgrade Notice ==
### 6.0.0
Links to settings pages have changed, as FloristPress settings have moved into the WooCommerce Settings page.
### 3.3.0
