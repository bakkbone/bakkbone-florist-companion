...
class BKF_Enqueue{
	...
	function global(){
		...
		wp_enqueue_style("bkf_bkf", BKF_URL . "assets/css/bkf.css", [],"1","all" );
		wp_enqueue_style("bkf_default", BKF_URL . "assets/css/default.css", [],"1","all" );
		wp_enqueue_style("bkf_calendar", BKF_URL . "assets/css/calendar.css", [],"1","all" );
		global $post_type;
		if ( 'bkf_petals_order' === $post_type ) {
			wp_enqueue_style("bkf_petals", BKF_URL . "assets/css/petals.css", [],"1","all" );
		}
	}
