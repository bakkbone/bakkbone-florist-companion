...
if ( ! class_exists( 'WC_Email_Petals_New' ) ) :
	...
	class WC_Email_Petals_New extends WC_Email {
		...
		public function get_default_subject() {
			return __( '[{site_title}]: New Petals Network Order #{order_number}', 'bakkbone-florist-companion' );
		}
		...
		public function get_default_heading() {
			return __( 'New Petals Order: #{order_number}', 'bakkbone-florist-companion' );
		}
