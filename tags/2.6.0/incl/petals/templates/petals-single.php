...
while ( have_posts() ) :
	if(current_user_can( 'read_petals_order')){
		...
		echo '<main><h2>'.__('Not Authorised', 'bakkbone-florist-companion').'</h2><p>'.__('Sorry, you must be logged in as an authorised user to view this content.','bakkbone-florist-companion').'</p></main>';
	}
	the_post();
