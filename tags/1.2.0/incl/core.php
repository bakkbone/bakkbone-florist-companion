...
class BkfCore{
    ...
    function bkf_settings_link( $links ) {
    	...
    	$api_support_link = "<a href='https://www.bakkbone.com.au/submitticket.php'>" . __( 'API Support' ) . '</a>';
    	$bkf_support_link = "<a href='https://wordpress.org/support/plugin/bakkbone-florist-companion/'>" . __( 'Plugin Support' ) . '</a>';
    	array_push( $links, $settings_link, $api_support_link, $bkf_support_link );
    	return $links;
    }
