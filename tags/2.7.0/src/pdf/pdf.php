...
class BkfPdf{
	...
	function worksheet($orderid){
		...
		if($tsraw !== ''){
			...
			$thists = $ts[$thistsid];
			$timeslot = '<br><small><small><small>'.wp_date("g:i a", strtotime($thists['start'])).' - '.wp_date("g:i a", strtotime($thists['end'])).'</small></small></small>';			
		} else {
			$timeslot = '';
		}
