...
while ( have_posts() ) :
	if(current_user_can( 'read_petals_order')){
		...
		if($upsellamt !== '' && $upsellamt !== null){ echo '<tr><th>'.BKF_PO_FIELD_UPSELLAMT.'</th><td>'.bkf_currency_symbol().$upsellamt.'</td></tr>'; }
		if($tvalue !== '' && $tvalue !== null){ echo '<tr><th>'.BKF_PO_FIELD_TVALUE.'</th><td>'.bkf_currency_symbol().$tvalue.'</td></tr>'; }
