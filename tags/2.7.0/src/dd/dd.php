	    	...
	    	<script id="bkf_ddfield">
	    	    jQuery(document).ready(function( $ ) {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['monday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 1) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 				if(isset(get_option('bkf_dm_setting')['monday'])){
	 					...
	 					if(w == 1 && monday_items.includes(currentShippingMethod)){
	 						return [false, "unavailable", '<?php echo BKF_DD_UA_TEXT; ?>'];
	 					}
	 					<?php
	 				}
	 			}; ?>
	 			<?php if(get_option('bkf_dd_setting')['tuesday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 2) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['wednesday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 3) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['thursday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 4) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['friday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 5) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['saturday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 6) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
	 			...
	 			<?php if(get_option('bkf_dd_setting')['sunday'] == false){ ?>
	 				if (date >= new Date("<?php echo bkf_get_monday(); ?>") && w == 0) { return [false, "closed", <?php echo BKF_DD_CLOSED_TEXT; ?>]; }<?php } else {
			 ...
			 <?php if($sdcpassed == true){
				 ...
				 if(d == "<?php echo wp_date("j"); ?>" && y == "<?php echo wp_date("Y"); ?>" && m == <?php echo wp_date("n"); ?> - 1){
					 return [false,"sdc","<?php echo BKF_DD_SDC_TEXT; ?>"];
					 }<?php
			 }?>
