...
class BkfAdminNotices{
	...
	function dashnews(){
		...
		echo '<div style="text-align:center"><img src="'.BKF_URL.'assets/img/B22_landscape_250.png" style="max-width:150px;"/><h3>'.esc_html__('News and updates from the FloristPress team', 'bakkbone-florist-companion').'</h3></div>';
		echo '<ul>';
