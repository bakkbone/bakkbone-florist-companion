...
class BkfDsPosts{
	...
	function dspost_help(){
		...
		<h2><?php echo BKF_HELP_SUBTITLE; ?></h2>
			<a href="https://docs.bkbn.au/v/bkf/delivery-suburbs/using-delivery-suburbs" target="_blank">https://docs.bkbn.au/v/bkf/delivery-suburbs/using-delivery-suburbs</a>
		<?php
	}
