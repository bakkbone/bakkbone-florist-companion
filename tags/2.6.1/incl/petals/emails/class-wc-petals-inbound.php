<?php
/**
 * Class WC_Email_Petals_Inbound file
 *
...
if ( ! class_exists( 'WC_Email_Petals_Inbound' ) ) :
	...
	class WC_Email_Petals_Inbound extends WC_Email {
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Petals Order #{order_number}', 'bakkbone-florist-companion' );
		}
		...
		public function get_default_heading() {
			return __( 'Petals Note for order: #{order_number}', 'bakkbone-florist-companion' );
		}
