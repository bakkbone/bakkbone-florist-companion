...
define("__BKF_PATH_BD__", __BKF_PATH_SRC__.'/bd');
...
function bkf_debug($script = false){
	$default = defined(WP_DEBUG) ? WP_DEBUG : false;
	if ($script && !$default && defined(SCRIPT_DEBUG)) {
...
add_action( 'before_woocommerce_init', function() {
	if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
		...
		\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'cart_checkout_blocks', __BKF_FILE__, false );
	}
} );
...
require __BKF_PATH_CORE__ . "/classes.php";
...
add_filter('woocommerce_get_settings_pages', function($settings){
	...
	$settings[] = include __BKF_PATH_SRC__ . "/dd/dd-settings.php";
	return $settings;
});
...
require __BKF_PATH_SRC__ . "/dd/fees.php";
require __BKF_PATH_SRC__ . "/dd/dd-options.php";
require __BKF_PATH_SRC__ . "/dd/hygiene.php";
