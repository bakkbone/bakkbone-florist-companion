...
while ( have_posts() ) :
	if(current_user_can( 'read_petals_order')){
		...
		if($description !== '' && $description !== null){ echo '<tr><th>'.__('Description', 'bakkbone-florist-companion').'</th><td>'.$description.'</td></tr>'; }
		if($productid !== '' && $productid !== null){ echo '<tr><th>'.__('Petals Product ID', 'bakkbone-florist-companion').'</th><td>'.$productid.'</td></tr>'; }
		if($makeup !== '' && $makeup !== null){ echo '<tr><th>'.__('Makeup', 'bakkbone-florist-companion').'</th><td>'.$makeup.'</td></tr>'; }
		if($upsell !== '' && $upsell !== null){ echo '<tr><th>'.__('Add-Ons', 'bakkbone-florist-companion').'</th><td>'.$upsell.'</td></tr>'; }
		if($upsellamt !== '' && $upsellamt !== null){ echo '<tr><th>'.__('Add-Ons Value', 'bakkbone-florist-companion').'</th><td>'.bkf_currency_symbol().$upsellamt.'</td></tr>'; }
		if($tvalue !== '' && $tvalue !== null){ echo '<tr><th>'.__('Total Order Value', 'bakkbone-florist-companion').'</th><td>'.bkf_currency_symbol().$tvalue.'</td></tr>'; }
		if($deldate !== '' && $deldate !== null){ echo '<tr><th>'.__('Delivery Date', 'bakkbone-florist-companion').'</th><td>'.$deldate.'</td></tr>'; }
		if($deltime !== '' && $deltime !== null){ echo '<tr><th>'.__('Delivery Time', 'bakkbone-florist-companion').'</th><td>'.$deltime.'</td></tr>'; }
		if($recipient !== '' && $recipient !== null){ echo '<tr><th>'.__('Recipient\'s Name', 'bakkbone-florist-companion').'</th><td>'.$recipient.'</td></tr>'; }
		if($surname !== '' && $surname !== null){ echo '<tr><th>'.__('Recipient\'s Surname', 'bakkbone-florist-companion').'</th><td>'.$surname.'</td></tr>'; }
		if($addresstype !== '' && $addresstype !== null){ echo '<tr><th>'.__('Address Type', 'bakkbone-florist-companion').'</th><td>'.$addresstype.'</td></tr>'; }
		if($address !== '' && $address !== null){ echo '<tr><th>'.__('Street Address', 'bakkbone-florist-companion').'</th><td>'.$address.'</td></tr>'; }
		if($town !== '' && $town !== null){ echo '<tr><th>'.__('Town/City', 'bakkbone-florist-companion').'</th><td>'.$town.'</td></tr>'; }
		if($state !== '' && $state !== null){ echo '<tr><th>'.__('State/Province', 'bakkbone-florist-companion').'</th><td>'.$state.'</td></tr>'; }
		if($postalcode !== '' && $postalcode !== null){ echo '<tr><th>'.__('Postal Code', 'bakkbone-florist-companion').'</th><td>'.$postalcode.'</td></tr>'; }
		if($crtyname !== '' && $crtyname !== null){ echo '<tr><th>'.__('Country', 'bakkbone-florist-companion').'</th><td>'.$crtyname.'</td></tr>'; }
		if($phone !== '' && $phone !== null){ echo '<tr><th>'.__('Recipient\'s Phone', 'bakkbone-florist-companion').'</th><td>'.$phone.'</td></tr>'; }
		if($message !== '' && $message !== null){ echo '<tr><th>'.__('Card Message', 'bakkbone-florist-companion').'</th><td>'.$message.'</td></tr>'; }
		if($occasion !== '' && $occasion !== null){ echo '<tr><th>'.__('Occasion', 'bakkbone-florist-companion').'</th><td>'.$occasion.'</td></tr>'; }
		if($comments !== '' && $comments !== null){ echo '<tr><th>'.__('Comments', 'bakkbone-florist-companion').'</th><td>'.$comments.'</td></tr>'; }
		if($supplier !== '' && $supplier !== null){ echo '<tr><th>'.__('Designated Executing Florist', 'bakkbone-florist-companion').'</th><td>'.$supplier.'</td></tr>'; }
		if($contact_name !== '' && $contact_name !== null){ echo '<tr><th>'.__('Customer Name', 'bakkbone-florist-companion').'</th><td>'.$contact_name.'</td></tr>'; }
		if($contact_email !== '' && $contact_email !== null){ echo '<tr><th>'.__('Customer Email', 'bakkbone-florist-companion').'</th><td>'.$contact_email.'</td></tr>'; }
		if($contact_phone !== '' && $contact_phone !== null){ echo '<tr><th>'.__('Customer Phone', 'bakkbone-florist-companion').'</th><td>'.$contact_phone.'</td></tr>'; }
		echo '</table>';
