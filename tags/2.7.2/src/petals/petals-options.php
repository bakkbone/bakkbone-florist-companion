...
class BkfPetalsOptions{
	...
	function bkfPetalsProductCallback(){
    	...
    	if(empty($value)) {
    	echo "<option value=\"\" selected>".__('Select a Product...', 'bakkbone-florist-companion')."</option>";    
    	}else{
    	echo "<option value=\"\">".__('Select a Product...', 'bakkbone-florist-companion')."</option>";}
