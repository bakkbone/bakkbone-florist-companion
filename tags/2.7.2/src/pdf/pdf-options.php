...
class BkfPdfOptions{
	...
	function add_pdf_downloads( $order ) {
		...
		if($petalson == null){
			echo '<p class="form-field form-field-wide wc-customer-user"><a href="'.$invurl.'">'.__('Download', 'bakkbone-florist-companion').' '.$invtitle.'</a></p>';
		}
		echo '<p class="form-field form-field-wide wc-customer-user"><a href="'.$wsurl.'">'.__('Download', 'bakkbone-florist-companion').' '.$wstitle.'</a></p>';
	}
