...
class BkfLocalisation{
	...
	function bkfCsHeadingCallback(){
		...
		?>
		<input class="bkf-form-control large-text" id="csheading" type="text" name="bkf_localisation_setting[csheading]" placeholder="<?php _e('How about adding...','bakkbone-florist-companion'); ?>" value="<?php echo $value; ?>" />
	...
	function bkfNoshipCallback(){
		...
		?>
		<input class="bkf-form-control large-text" id="noship" type="text" name="bkf_localisation_setting[noship]" placeholder="<?php _e('You have selected a suburb or region we do not deliver to.','bakkbone-florist-companion'); ?>" value="<?php echo $value; ?>" />
