...
class BKF_Ajax{
	...
	function __construct(){
		...
		// Resend invoice
		add_action('wp_ajax_bkf_resend_invoice', array($this, 'resend_invoice'));
		add_action('wp_ajax_bkf_nopriv_valid_order', array($this, 'is_valid_order'));
		add_action('wp_ajax_bkf_valid_order', array($this, 'is_valid_order'));
	}
