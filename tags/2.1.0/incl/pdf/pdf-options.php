...
class BkfPdfOptions{
    ...
    function __construct(){
        ...
        add_action("admin_menu", array($this,"bkf_pdf_menu"));
    ...
    function bkf_pdf_menu(){
        ...
        __("PDF Invoices and Worksheets","bakkbone-florist-companion"),//page title
        __("PDFs","bakkbone-florist-companion"),//menu title
        "manage_options",//capability
        "bkf_pdf",//menu slug
        array($this, "bkf_pdf_settings_page"),//callback
        20
        );
    }
	...
	function bkfAddPdfPageInit()
	{
		...
		register_setting(
			"bkf_pdf_options_group",// group
			"bkf_pdf_setting", //setting name
			array($this,"bkfAddPdfOptionsSanitize") //sanitize_callback
		);
