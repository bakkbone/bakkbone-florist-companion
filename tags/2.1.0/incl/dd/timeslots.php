...
class BkfDdTsOptions{
    ...
    function __construct(){
		...
		add_action( 'wp_footer', array($this,'checkout_shipping_packing_script'));
   ...
   die();		
	...
	function add_ts_fee( $cart ) {
		...
		$tax = get_option('bkf_ddi_setting')['ddtst'];
