<?php
/**
 * Class WC_Email_Petals_New file
 *
...
if ( ! class_exists( 'WC_Email_Petals_New' ) ) :
	...
	class WC_Email_Petals_New extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'New Petals Order', 'woocommerce' );
			$this->description    = __( 'New Petals Order emails are sent to chosen recipient(s) when a new order from Petals is received.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: New Petals Network Order #{order_number}', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'New Petals Order: #{order_number}', 'woocommerce' );
		}
		...
		public function get_default_additional_content() {
			return __( 'You can accept or reject this order from your website\'s dashboard.', 'woocommerce' );
		}
