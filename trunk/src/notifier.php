...
class BkfNotifier{
	...
	function bkf_notifier_help(){
		...
		<h2><?php echo BKF_HELP_SUBTITLE; ?></h2>
			<a href="https://plugins.bkbn.au/docs/bkf/day-to-day/orders-list/#order-notifier" target="_blank">https://plugins.bkbn.au/docs/bkf/day-to-day/orders-list/#order-notifier</a>
		<?php
	}
