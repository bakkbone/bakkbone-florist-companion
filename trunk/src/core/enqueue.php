...
class BKF_Enqueue{
	...
	function global(){
		...
		wp_enqueue_style("bkf_bkf", __BKF_URL__ . "assets/css/bkf.css", [],"1","all" );
		wp_enqueue_style("bkf_default", __BKF_URL__ . "assets/css/default.css", [],"1","all" );
		wp_enqueue_style("bkf_calendar", __BKF_URL__ . "assets/css/calendar.css", [],"1","all" );
		global $post_type;
		if ( 'bkf_petals_order' === $post_type ) {
			wp_enqueue_style("bkf_petals", __BKF_URL__ . "assets/css/petals.css", [],"1","all" );
		}
	}
	
	function frontend(){
		if (is_checkout()) {
			wp_enqueue_script("bkf_dd", __BKF_URL__ . "assets/js/dd.js", ['jquery']);
	...
	function backend(){
		...
		wp_enqueue_script("bkf_copy", __BKF_URL__ . "assets/js/copy.js",'','','all' );
		...
		if(get_post_type() == 'bkf_petals_order'){
			...
			wp_enqueue_script("bkf_petals", __BKF_URL__ . "assets/js/petals.js",'','','all' );
		}
