                ...
                <div class="inside">
					...
					<div class="bkf-form" style="max-width:200px;text-align:center;margin: 12px auto;">
						<form id="add-closed" action="<?php echo $ajaxurl; ?>" />
							...
							<p style="margin:5px 0;"><input type="text" name="date" class="fee-date input-text bkf-form-control" required autocomplete="off" placeholder="<?php _e("Date", "bakkbone-florist-companion"); ?>" style="max-width:170px;" /></p>
							...
							<p style="margin:5px 0;"><input class="input-text bkf-form-control" type="text" name="title" placeholder="<?php _e('Fee Title', 'bakkbone-florist-companion'); ?>" required style="max-width:170px;" /></p>
		      ...
		      document.addEventListener('DOMContentLoaded', function() {
				...
				if(null !== $fees){
					foreach($fees as $ts => $array){
						...
						echo '{ title: \''.$array['title'].': '.bkf_currency_symbol().$array['fee'].'\', start: \'' . $string . '\', className: \'closedbg\' }, ';
					}
				}
