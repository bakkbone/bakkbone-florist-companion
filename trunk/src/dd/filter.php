	...
	function action_parse_query($query){ 
		...
		if($post_type == 'shop_order'){
			if($show_all == 'true'){
				...
				$query->set('post_status', array("wc-processing","wc-made","wc-collect","wc-out","wc-scheduled","wc-new","wc-accept"));
			}
	...
	<script id="bkf_dd_filter">
	    	    jQuery(document).ready(function( $ ) {
				        ...
				        afterShow.done(function(){
				            ...
				            var btn = $('<button class="ui-datepicker-current ui-state-default ui-priority-primary ui-corner-all" type="button"><?php _e('Clear', 'bakkbone-florist-companion'); ?></button>');
